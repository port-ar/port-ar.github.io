...
description: 'A set of five stickers and informational cards showcasing animals that can be found in Minnesota. Click for more information and full graphics.'
date: 2025/04
tags: ['Graphic Design', 'Adobe Illustrator']
image: './mn-animals-banner.png'
authors: []
---
![Alt text](./mn-animals-banner.png)
